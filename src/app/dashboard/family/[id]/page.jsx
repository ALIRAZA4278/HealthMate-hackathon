    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/dashboard" className="text-pink-600 hover:text-pink-700">
            Back to Dashboard
          </Link>
        </div>
      </div>
      ...
      <nav className="bg-white shadow-sm border-b sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/dashboard" className="text-gray-600 hover:text-pink-600 transition font-medium">
              ← Back to Dashboard
            </Link>
          </div>
        </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="px-6 py-3 bg-gradient-to-r from-pink-500 to-orange-500 text-white rounded-lg font-semibold hover:shadow-lg transition"
              >
                + Add Report
              </Link>
              <Link
                href="/dashboard/vitals"
                className="px-6 py-3 border-2 border-pink-500 text-pink-600 rounded-lg font-semibold hover:bg-pink-50 transition"
              >
                + Add Vitals
              </Link>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-100">
          ...
          {reports.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Link
                href="/dashboard/upload"
                className="inline-block bg-gradient-to-r from-pink-500 to-orange-500 text-white px-6 py-2 rounded-lg hover:shadow-lg transition"
              >
                Upload First Report
              </Link>
            </div>
